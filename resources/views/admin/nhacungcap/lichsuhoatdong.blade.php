...
<div>Lịch sử thao tác trên nhà cung cấp <a href="/admin/nhacungcap/sua/{{$nhacungcap->id}}">{{$nhacungcap->nhacungcap_ten}}</a></div>
<table style="">
@foreach($nhacungcap->revisionHistory()->latest('created_at')->get() as $history )
