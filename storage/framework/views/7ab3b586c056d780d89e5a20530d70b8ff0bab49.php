<?php $__env->startSection('content'); ?>
    ...
    <form action="admin/donvitinh/sua/<?php echo e($donvitinh->id); ?>" method="POST">
    ...
    <div class="col-lg-12">
        <div class="form-group">
            ...
            <input class="form-control" name="donvitinh_ten" placeholder="Nhập tên đơn vị tính..." value="<?php echo $donvitinh->donvitinh_ten; ?>" />
            <div style="color: red">
