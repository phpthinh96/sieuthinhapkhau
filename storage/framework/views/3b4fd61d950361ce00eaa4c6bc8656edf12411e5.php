...
<div>Lịch sử thao tác trên nhà cung cấp <a href="/admin/nhacungcap/sua/<?php echo e($nhacungcap->id); ?>"><?php echo e($nhacungcap->nhacungcap_ten); ?></a></div>
<table style="">
<?php $__currentLoopData = $nhacungcap->revisionHistory()->latest('created_at')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
