        ...
        <div class="panel panel-<?php echo e($color); ?>">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo e($dh->id); ?>" ><p style="color:black;"><b>Mã đơn hàng #<?php echo e($dh->id); ?> | <i>Tình trạng:</i> <?php echo e($dh->tinhtrangdonhang->tinhtrangdonhang_ten); ?></b></p></a>
