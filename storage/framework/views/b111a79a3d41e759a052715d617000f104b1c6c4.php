...
<div class="panel-body">
    ...
    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
        ...
        <tbody>
            <?php $__currentLoopData = $sanphamnhapvao; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           
            <tr class="odd gradeX" align="center">
                <td><?php echo $item->sanpham->sanpham_ky_hieu; ?></td>
                ...
                <td>
                 ...
                 <td><?php echo $item->sanpham->sanpham_gia; ?> vnđ</td>
