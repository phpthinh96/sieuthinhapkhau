...
<div>Lịch sử thao tác trên sản phẩm <a href="/admin/sanpham/sua/<?php echo e($sanpham->id); ?>"><?php echo e($sanpham->sanpham_ten); ?></a></div>
<table style="">
<?php $__currentLoopData = $sanpham->revisionHistory()->latest('created_at')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
